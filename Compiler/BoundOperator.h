...
public:
  ...
  BoundUnaryOperator(SyntaxKind _syntaxkind, BoundUnaryOperatorKind _kind,
      ...
      : syntaxkind(_syntaxkind), kind(_kind), operandType(_operandType),
...
public:
  BoundBinaryOperator(SyntaxKind _syntaxkind, BoundBinaryOperatorKind _kind,
      ...
      : syntaxkind(_syntaxkind), kind(_kind), lefttype(_lefttype),
        righttype(_righttype), resultType(_resulttype) {}
  SyntaxKind syntaxkind;
