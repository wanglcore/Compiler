...
public:
  BlockStatementSyntax(
      ...
      : StatementSyntax(SyntaxKind::BlockStatement),
        openBraceToken(_openBraceToken), statements(_statements),
...
public:
  ...
  VariableDeclarationSyntax(std::shared_ptr<SyntaxToken> _keyword,
                            ...
                            std::shared_ptr<SyntaxToken> _equalsToken,
                            std::shared_ptr<ExpressionSyntax> _initializer)
      : StatementSyntax(SyntaxKind::VariableDeclaration), keyword(_keyword),
        mutkeyword(_mutkeyword), identifier(_identifier),
        equalsToken(_equalsToken), initializer(_initializer) {}
